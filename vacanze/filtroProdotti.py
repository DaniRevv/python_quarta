...
def selezionaProdotti(lista, pMax):
    listaNuova = []
    for prodotto in lista:
        if prodotto["prezzo"] < pMax:
            listaNuova.append(prodotto["nome"])
...
def main():
    ...
    prodottiSelezionati = selezionaProdotti(prodotti, 200)
    print(prodottiSelezionati)
